...
class SmartPlug:
    ...
    def __init__(self,consumptionRate):
        ...
        self.deviceType = "SmartPlug" # I introduced this to make it easier to modify the edit button
...
class SmartHeater:
    ...
    def __init__(self):
        self.switchedOn = False 
        self.option = 0
        self.deviceType = "SmartHeater"  # I introduced this to make it easier to modify the edit button
